...
static void addswitch(GtkWidget *widget, gpointer data)
{
			...
			gtk_drag_source_set(GTK_WIDGET(widget),GDK_BUTTON1_MASK,NULL,0,GDK_ACTION_MOVE);
...
static void bulbdisplay(GtkWidget *widget, gpointer data)
{
			...
			//GooCanvasItem *path = goo_canvas_path_new (root,"M40,40 L40,30 L35,30 L35,25 C35,25 10,12.5 40,0 M40,0 C40,0 70,12.5 45,25 M45,25 L45,30 L40,30 M45,25 L35,25","fill-color","yellow","stroke-color","black",NULL);
}
...
int main(int argc, char *argv[]) {
  ...
  g_signal_connect(GTK_BUTTON(toggle2),"clicked", G_CALLBACK(addoutputtoggle),NULL);  
